...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_reducers.searchReducer);

	_reactDom2.default.render(_react2.default.createElement(
	  _reactRedux.Provider,
	  { store: store, key: 'provider' },
	  _react2.default.createElement(_components.Container, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearcherForm = __webpack_require__(187);

	var _Modal = __webpack_require__(188);

	var _ErrorMessage = __webpack_require__(189);

	var _ResultsSection = __webpack_require__(190);
	...
	var Container = exports.Container = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(175)(global || window || undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SearcherForm = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ErrorMessage = exports.ErrorMessage = function ErrorMessage() {
	  var text = " Oops! Are you sure that's an artist?";
	  return _react2.default.createElement(
	    "div",
	    { id: "result-error" },
	    "ಠ_ಠ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ResultsSection = undefined;

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _Album = __webpack_require__(191);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ResultsSection = exports.ResultsSection = _react2.default.createClass({
	  displayName: 'ResultsSection',

	  propTypes: {
	    artist: _react2.default.PropTypes.object,
	    albums: _react2.default.PropTypes.array,
	    topTracks: _react2.default.PropTypes.array
	  },
	  render: function render() {
	    var errorMessage = "Oops! This artist has no albums on Spotify!";
	    if (this.props.artist && this.props.albums && this.props.topTracks) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'label', id: 'result-info' },
	          this.props.artist.name
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'result-goodies', id: 'albums' },
	          this.props.albums.length > 0 ? this.props.albums.map(function (album) {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'ol',
	            null,
	            this.props.topTracks.map(function (track) {
	              return _react2.default.createElement(
	                'li',
	                { key: track.id },
	                track.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Album = exports.Album = function Album(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement("img", { className: "album-image", src: album.images[0].url }),
	    _react2.default.createElement(
	      "p",
	      null,
	      album.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search = exports.search = function search(searchTerm, dispatch) {
	  _axios2.default.get('https://api.spotify.com/v1/search?q=' + searchTerm + '&type=artist&limit=1').then(function (response) {
	    ...
	    dispatch(searchError({ searchTerm: searchTerm, response: response }));
	    return;
	  });
	...
	var getAlbums = exports.getAlbums = function getAlbums(artistId, dispatch) {
	  _axios2.default.get('https://api.spotify.com/v1/artists/' + artistId + '/albums?album_type=album&market=US&limit=5').then(function (response) {
	    ...
	    var albums = response.data.items.filter(function (e, i, a) {
	      var dupIndex = a.findIndex(function (e2, i2, a2) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchReducer = exports.searchReducer = function searchReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { error: false } : arguments[0];
	  var action = arguments[1];
